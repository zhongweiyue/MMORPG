...
namespace GameServer.Models
{
    class Chat
    {
        ...
        public void PostProcess(NetMessageResponse message) 
        {
            ...
            {
            teamIdx = ChatManager.Instance.GetTeamMessages(this.Owner.Team.Id, this.teamIdx, message.Chat.teamMessages);
            }
            if (this.Owner.Guild != null)
            {
                guildIdx = ChatManager.Instance.GetGuildMessages(this.Owner.Guild.Id, this.guildIdx, message.Chat.guildMessages);
            }
        }
    }
}
